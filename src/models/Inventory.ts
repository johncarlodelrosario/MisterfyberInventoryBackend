...
export interface IInventory extends Document {
  ...
  siteIds: mongoose.Types.ObjectId[]; // Changed from single siteId to array
  quantities: Map<string, number>; // siteId -> quantity
  prices: Map<string, number>; // siteId -> price
  minQuantities: Map<string, number>; // siteId -> minQuantity
  unit: string;
  description?: string;
  lastUpdated: Date;
