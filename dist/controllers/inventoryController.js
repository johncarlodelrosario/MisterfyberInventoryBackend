...
exports.moveInventory = exports.deductInventory = exports.deleteInventory = exports.updateInventory = exports.getInventoryById = exports.getInventory = exports.createInventory = void 0;
...
const moveInventory = async (req, res) => {
    try {
        ...
        const fromSiteObjectId = new mongoose_1.default.Types.ObjectId(fromSiteId);
        const fromSiteExists = inventory.siteIds.some((id) => id.equals(fromSiteObjectId));
        if (!fromSiteExists) {
            return res.status(404).json({
                success: false,
        ...
        const toSiteObjectId = new mongoose_1.default.Types.ObjectId(toSiteId);
        const toSiteExists = inventory.siteIds.some((id) => id.equals(toSiteObjectId));
        if (!toSiteExists) {
            return res.status(404).json({
                success: false,
...
exports.moveInventory = moveInventory;
